...
import 'package:tencent_rtc_plugin/enums/pixel_format_enum.dart';
...
import 'package:tencent_rtc_plugin/enums/video_buffer_type_enum.dart';
...
class TencentRtcPlugin {
  ...
  /// 设置本地视频的自定义渲染回调。
  /// [streamType] 流类型
  static setLocalVideoRender({
    @required PixelFormatEnum pixelFormat,
    @required VideoBufferTypeEnum bufferType,
  }) {
    return _channel.invokeMethod('setLocalVideoRender', {
      "pixelFormat": PixelFormatTool.toInt(pixelFormat),
      "bufferType": VideoBufferTypeTool.toInt(bufferType),
    });
  }
