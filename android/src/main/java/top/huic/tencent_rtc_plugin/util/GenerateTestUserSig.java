...
public class GenerateTestUserSig {
     ...
     */
    public static String genTestUserSig(long sdkappid, String secretkey, String userId) {
    ...
    private static String GenTLSSignature(long sdkappid, String userId, long expire, byte[] userbuf, String priKeyContent) {
        ...
        compressor.end();
        String sign = new String(base64EncodeUrl(Arrays.copyOfRange(compressedBytes, 0, compressedBytesLength)));
        return sign;
    }
